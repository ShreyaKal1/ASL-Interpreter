...
Original file is located at
    https://colab.research.google.com/drive/1FbOWmWqOPG436aredlodcfRshq4NmVMk
"""
...
X_test = X_test.reshape(X_test.shape[0], 7*7*512) #first num of shape
...
model.add(Dense(51, activation='softmax')) #last num of shape
...
model.add(Dense(128, activation='relu'))
model.add(Dropout(0.5))
model.add(Dense(8, activation='softmax')) #last num
